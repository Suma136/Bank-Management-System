...
string banksystem::up="";
  ...
  void banksystem::add_acc()
    ...
    void banksystem::deposit()
    {
        ...
        qstate = mysql_query(conn,query.c_str());
        qstate==0 ? cout<<"Amount Deposited :)" : cout<<"Something is Wrong...\n";
        system("pause");
    }
    ...
    void banksystem::withdraw()
    {
        ...
        qstate = mysql_query(conn,query.c_str());
        qstate==0 ? cout<<"Amount withdrawed (:" : cout<<"Something is Wrong...\n";
        system("pause");
    }
...
if (a.conn)
	...
	cout << "\n\t\t   passcode: ";
	cin >> password;
	cout << "\t\tYou are entering please wait";
   ...
   {
    system("cls");
    puts("You are an Valuable Customer of BANK");
